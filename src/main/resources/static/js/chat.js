...
// 透過 EventSource 可以不間斷得持續收到 Server 端傳來得訊息直到 close 為止
// 每收到一個訊息就會觸發 onmessage
function stream(){
	const question = questionInput.value.trim();
